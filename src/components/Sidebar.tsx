  ...
  return (
    <aside className='bg-secondary flex flex-col w-nav'>
      ...
      <nav className='px-4 pt-0.5'>
        <Link className='sprint-nav-link' to="/sprint/dist/basic" inactiveProps={{ className: 'text-inactive-nav-link' }} activeProps={{ className: 'text-active-nav-link bg-tertiary' }}><i className="fa-solid fa-wrench sprint-nav-icon text-xl"></i>Basic</Link>
        <Link className='sprint-nav-link' to="/sprint/dist/advance" inactiveProps={{ className: 'text-inactive-nav-link' }} activeProps={{ className: 'text-active-nav-link bg-tertiary' }}><i className="fa-solid fa-gear sprint-nav-icon text-xl"></i>Advanced</Link>
